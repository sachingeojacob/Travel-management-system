VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} employee_report 
   Bindings        =   "employee_report.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   6690
   ClientLeft      =   120
   ClientTop       =   465
   ...
   EndProperty
End
Attribute VB_Name = "employee_report"
